	...
	case "exec.name":
		return &eval.StringEvaluator{
			EvalFnc: func(ctx *eval.Context) string {
				...
				return (*Event)(ctx.Object).Exec.Name
		...
		return &eval.StringEvaluator{
			EvalFnc: func(ctx *eval.Context) string {
				...
				if reg.Value != nil {
					...
					result = element.ProcessContext.ExecEvent.Name
	...
	case "process.name":
		return &eval.StringEvaluator{
			EvalFnc: func(ctx *eval.Context) string {
				...
				return (*Event)(ctx.Object).Process.ExecEvent.Name
...
func (e *Event) GetFieldValue(field eval.Field) (interface{}, error) {
	...
	case "process.name":
		...
		return e.Process.ExecEvent.Name, nil
...
func (e *Event) SetFieldValue(field eval.Field, value interface{}) error {
	...
	case "process.name":
		...
		if e.Process.ExecEvent.Name, ok = value.(string); !ok {
			return &eval.ErrValueTypeMismatch{Field: "Process.ExecEvent.Name"}
		}
		return nil
